...
<div class="container-fluid">
  <div class="row justify-content-center">
    <div class="col-12">
      <h2 class="mb-2 page-title">Data Keranjang</h2>
          ...
          <div class="card shadow-lg">
            <div class="card-body">
              <div class="">
                ...
                @include('admin.keranjang.create')
              </div>
                  ...
                  @if (count($keranjangs))
                    @foreach ($keranjangs as $keranjang)
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('produk.destroy', $keranjang->id) }}" method="post">
                                    @csrf
                                    @method('delete')
                                    <a href="{{ route('produk.show', $keranjang->id) }}"
                                        class="btn btn-sm btn-warning" data-bs-toggle="tooltip"
                                        data-bs-offset="0,4" data-bs-placement="top" data-bs-html="true"
                                        title="Show Data">
                                        S
                                    </a> |
                                    <a href="{{ route('produk.edit', $keranjang->id) }}"
                                        class="btn btn-sm btn-secondary" data-bs-toggle="tooltip"
                                        data-bs-offset="0,4" data-bs-placement="top" data-bs-html="true"
                                        title="Edit Data">
                                        edit
                                    </a> |
                                    <button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#defaultModal{{ $keranjang->id }}"> Hapus </button>
                                    <div class="modal fade" id="defaultModal{{ $keranjang->id }}" tabindex="-1" role="dialog" aria-labelledby="defaultModalLabel" aria-hidden="true">
